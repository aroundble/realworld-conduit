...
description: Use when writing new code. Immutability and no-mutation principles, small-function discipline, DRY via extraction, readable names. Ported from everything-claude-code.
---
