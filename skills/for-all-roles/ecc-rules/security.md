...
---
name: ecc-security
description: Use before committing. Pre-commit security checklist: secret scanning, dependency audit, injection surface review. Ported from everything-claude-code.
---
